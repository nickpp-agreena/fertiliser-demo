  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <div className="relative w-4 h-4 flex items-center justify-center">
        <ChevronDownIcon size={16} className="absolute text-[#4730DB] group-data-[state=open]:hidden" />
        <ChevronUpIcon size={16} className="absolute text-[#4730DB] hidden group-data-[state=open]:block" />
      </div>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("text-[12px] leading-[150%] font-normal text-[#747474]", className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center py-1.5 px-0 text-[14px] leading-[150%] font-normal text-[#0D0D0D] outline-none hover:bg-[#F2F2F2] focus:bg-[#F2F2F2] data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
