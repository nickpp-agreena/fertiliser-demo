            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${assignedPlan && !isSelected ? 'opacity-75 bg-muted/20 border-warning/50' : ''}
                  ${isAssignedToThis ? 'bg-primary/10 border-primary' : ''}
                `}
              >
                ...
                <div className="mt-2 text-xs">
                  ...
                  {assignedPlan && !isSelected && (
                    <span className="text-warning font-medium truncate">
                      ⚠ Assigned to {truncatePlanName(assignedPlan.name)}
                    </span>
                  )}
                  {!assignedPlan && !isAssignedToThis && !isSelected && (
